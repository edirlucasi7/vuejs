<template>
	<div id="app">
		<usuario-lista @infomacaoUsuario="usuarioSelecionado = $event" 
		:usuarios="[...usuarios]" />
		<usuario-detalhe :usuarioSelecionado="usuarioSelecionado"
		@resetarDetalhesUsuario="usuarioSelecionado = $event"/>
	</div>
</template>
